...
export default function LoginSignup({ onLogin }: LoginSignupProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F1E9EE] px-4 py-12 relative overflow-hidden">
      {/* Decorative background visual elements */}
      <div className="absolute top-[-10%] right-[-10%] w-[400px] h-[400px] rounded-full bg-[#714B67] opacity-5 pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[350px] h-[350px] rounded-full bg-[#00A09D] opacity-5 pointer-events-none" />

      <div className="w-full max-w-md bg-white border border-[#E5E4EA] rounded-xl shadow-sm overflow-hidden z-10 transition-all duration-300 hover:shadow-md">
        {/* Top Header Section */}
        <div className="bg-[#714B67] p-8 text-center text-white relative">
          ...
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-white text-[#714B67] font-bold text-2xl shadow-sm mb-3">
            AF
          </div>
          <h1 className="text-2xl font-bold tracking-tight">AssetFlow</h1>
          <p className="text-xs text-[#F1E9EE] mt-1">Enterprise Asset & Resource ERP</p>
        </div>
